...
class SuccessImport
  ...
  def import_events
    puts "Success import of events from: #{@file_path}"
    ...
    begin
      ...
      default_user = Usuario.find_by(email: 'system@4alocadora.com') || Usuario.create!(
        nome: 'System Import',
        email: 'system@4alocadora.com',
        cpf: '12345678901',
        password: 'temp123456',
        perfil: 'admin',
        ativo: true
      ...
      (2..sheet.last_row).each do |row|
        begin
          ...
          # Create event using ActiveRecord with required fields
          evento = Evento.new(
...
if __FILE__ == $0
  ...
  importer = SuccessImport.new(file_path)
